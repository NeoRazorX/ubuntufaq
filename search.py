...
class Detalle_tag(Pagina):
    def get(self, tag=None):
        ...
        template_values = {
                ...
                'descripcion': r'Páginas relacionadas con ' + tag,
                'tag': tag,
                'tags': 'problema, duda, ayuda, ' + tag,
                'relacionadas': self.paginas_relacionadas(tag, True),
    ...
    def post(self, ntag=None):
        ...
        template_values = {
                ...
                'descripcion': r'Resultados de: ' + query,
                'tag': query,
                'buscando': True,
                'tags': 'problema, duda, ayuda, ' + query,
                'relacionadas': self.buscar( query ),
                'searches': memcache.get('all-searches'),
                'url': self.url,
                'url_linktext': self.url_linktext,
                'mi_perfil': self.mi_perfil,
...
def main():
    application = webapp.WSGIApplication( [(r'/search/(.*)', Detalle_tag)], debug=DEBUG_FLAG )
